<form id="ayuda_online" action="" method="post">
    <h2 id="titulo">Ayuda</h2>
    <br>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 form-group">
                <a>Modulo de Usuarios.</a>
            </div>
            <br>
            <div class="col-md-12 form-group">
                <a>Modulo de Clientes.</a>
            </div>
            <br>
            <div class="col-md-12 form-group">
                <a>Modulo de Proveedores.</a>
            </div>
            <br>
            <div class="col-md-12 form-group">
                <a>Modulo de Productos.</a>
            </div>
            <br>
            <div class="col-md-12 form-group">
            ...
            <br>
            <div class="col-md-12 form-group">
                <a>Modulo de Compras.</a>
            </div>
            <br>
            <div class="col-md-12 form-group">
                <a>Modulo de Pedidos.</a>
            </div>
            <br>
            <div class="col-md-12 form-group">
                <a>Modulo de Rutas.</a>
